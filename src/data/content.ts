...
const en: Dict = {
  ...
  lede: "I work at the intersection of <em>research, education, and institutional administration</em> — developing curriculum, advising on academic accreditation, and conducting qualitative research on gender, genocide memory, heritage, and cultural identity. I also translate across Kurdish, English, and Persian.",
...
const ku: Dict = {
  ...
  lede: "کارەکانم لە خاڵی بەیەکگەیشتنی <em>توێژینەوە، پەروەردە و کاروباری دامەزراوەیی</em>دایە — پەرەپێدانی مەنهەج، ڕاوێژکاری لەسەر پەسەندکردنی ئەکادیمی، و ئەنجامدانی توێژینەوەی چۆنایەتی لەسەر ڕەگەز، یادەوەری کۆمەڵکوژی، کەلەپوور و ناسنامەی کولتووری. ھەروەھا وەرگێڕان دەکەم لە نێوان کوردی، ئینگلیزی و فارسیدا.",
